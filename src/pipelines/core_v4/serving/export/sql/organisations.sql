...
SELECT o.id::VARCHAR AS id, o.openaireId, hm_clean(o.legalName) AS legalName, hm_clean(o.legalShortName) AS legalShortName, o.websiteUrl,
       list_transform(coalesce(o.alternativeNames, []), lambda n: hm_clean(n)) AS alternativeNames,
       ...
       o.geolocation_source, o.address_street, o.address_postalcode, o.address_city, o.address_country, o.nuts3,
